Feature: Capability to order digital services from OC2 MB connect shop for Polish market

  Scenario Outline:As a Polish OC2 shop visitor when purchasing digital services I would like to check-out and confirm the order.
    ...
    Examples:
      ...
      | poland       | WDD 177 046-1Z-000110        | Digital-radio     |