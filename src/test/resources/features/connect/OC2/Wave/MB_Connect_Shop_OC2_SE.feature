Feature: Capability to order digital services from OC2 MB connect shop for Swedish market

  Scenario Outline:As a Swedish OC2 shop visitor when purchasing digital services I would like to check-out and confirm the order.
    ...
    Examples:
      ...
      | sweden       | WDD 177 046-1Z-000130        | Digital-radio      |