Feature: Capability to order digital services from OC2 MB connect shop
  ...
  Scenario Outline:As a french OC2 shop visitor when purchasing digital services I would like to check-out and confirm the order.
    ...
    Examples:
      ...
      | france       | WDC 167 117-1Z-000003         | Smartphone-Integration   |