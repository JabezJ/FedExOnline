Feature: Capability to order digital services from OC2 MB connect shop for Austrian market

  Scenario Outline:As an Austrian OC2 shop visitor when purchasing digital services I would like to check-out and confirm the order.
    ...
    Examples:
      ...
      | austria      | WDC 167 159-2Z-000076        | Smartphone-Integration   |