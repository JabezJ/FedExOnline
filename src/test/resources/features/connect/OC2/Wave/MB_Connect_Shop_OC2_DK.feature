Feature: Capability to order digital services from OC2 MB connect shop for Danish market

  Scenario Outline:As a danish OC2 shop visitor when purchasing digital services I would like to check-out and confirm the order.
    ...
    Examples:
      ...
      | danmark      | WDD 297 123-1Z-900025         | Digital-radio      |