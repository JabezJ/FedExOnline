Feature: Capability to order digital services from OC2 MB connect shop for Czech market

  Scenario Outline:As a Czech OC2 shop visitor when purchasing digital services I would like to check-out and confirm the order.
    ...
    Examples:
      ...
      | czech        | WDD 177 086-1Z-000038        | Digital-radio      |